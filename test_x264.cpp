...
int main()
{
    ...
    params_[1].analyse.inter = X264_ANALYSE_I4x4 | X264_ANALYSE_I8x8 | X264_ANALYSE_PSUB16x16;
    params_[2].analyse.inter = X264_ANALYSE_I4x4 | X264_ANALYSE_I8x8 | X264_ANALYSE_PSUB16x16 | X264_ANALYSE_BSUB16x16;
    params_[3].analyse.inter = X264_ANALYSE_I4x4 | X264_ANALYSE_I8x8 | X264_ANALYSE_PSUB16x16 | X264_ANALYSE_BSUB16x16 | X264_ANALYSE_PSUB8x8 | X264_ANALYSE_PSUB8x8;
    ...
    for (int param = 0; param < numebers_of_params; param++)
    {
        ...
        FILE *file_size = fopen(("param_" + std::to_string(param) + "_size.json").c_str(), "w");
        fprintf(file_size, "[");
        ...
        FILE *file_duration = fopen(("param_" + std::to_string(param) + "_duration.json").c_str(), "w");
        ...
        // write the Encoding duration to file
        FILE *file_ssim = fopen(("param_" + std::to_string(param) + "_ssim.json").c_str(), "w");
        fprintf(file_ssim, "[");
